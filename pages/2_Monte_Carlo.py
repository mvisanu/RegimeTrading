...
def render_fan_chart(result: dict) -> None:
    ...
    fig.update_layout(
        ...
        xaxis={
            "title": {"text": "Trade Number", "font": {"color": "#7a7a9a"}},
            "showgrid": False,
            "zeroline": False,
            "tickfont": {"color": "#7a7a9a"},
        },
        yaxis={
            "title": {"text": "Portfolio Value ($)", "font": {"color": "#7a7a9a"}},
            "showgrid": False,
            "zeroline": False,
            "tickprefix": "$",
            "tickfont": {"color": "#7a7a9a"},
...
def render_dd_histogram(result: dict) -> None:
    ...
    fig.update_layout(
        ...
        font={"color": "#c0c0e0", "family": "'DM Sans', sans-serif", "size": 12},
        xaxis={
            "title": {"text": "Max Drawdown (%)", "font": {"color": "#7a7a9a"}},
            "showgrid": False,
            "zeroline": False,
            "ticksuffix": "%",
            "tickfont": {"color": "#7a7a9a"},
        ...
        yaxis={
            "title": {"text": "Frequency", "font": {"color": "#7a7a9a"}},
            "showgrid": False,
            "zeroline": False,
            "tickfont": {"color": "#7a7a9a"},
        },
